...
private let networkPlugin = NetworkActivityPlugin.init { (changeType, targetType) in
    ...
    case .began:
        print("开始请求网络")
//        TBProgressHUD .showStatusInfo("请稍后...")
    case .ended:
        print("结束")
//        TBProgressHUD.dismiss()
    }
}
...
//                    TBProgressHUD.showError("登陆失效，请重新登陆")
...
//                }else{
//
////                    showActiveViewToError(successTitle: "\(jsonData["error"]["message"])")
//                }
